...
<%
   ...
   ResultSet rs=stmt.executeQuery("select * from test");
    ...
    {   
       ...
       time=rs.getTime("ctime");
        DateFormat df = new SimpleDateFormat("dd MMM,yyyy");  
       String gd = df.format(date);     
       SimpleDateFormat sdf = new SimpleDateFormat("hh:mm a");
       String gt=sdf.format(time);
   
       
    out.print("<li><h3><a href='taketest.jsp?id="+test_id+"' class=''>"+test_id+"&nbsp;-&nbsp;&nbsp;"+desc+"</a></h3>");
       out.println("<p class='crt_desc'>"+"Created On: &nbsp;&nbsp;"+gd+""+" &nbsp; "+gt+""+"</p><br><br>");
       out.println("</p>");
       out.print("</li>");
