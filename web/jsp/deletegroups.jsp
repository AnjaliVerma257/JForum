...
<div id="sidebar">
 ...
 <%
    ...
    int forum_id=0;
    String name=null;
    out.println("<form method='post' action='deleteselectgroups.jsp'>");
     out.print("<pre style='font-family:monotype corsiva; font-size:xx-large; color:black; margin-left:400px'>DELETE GROUPS</pre><hr style='width:700px;'>");
    while(rs.next())
    {
