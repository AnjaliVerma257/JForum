...
<div id="sidebar">
    ...
    int n=stmt.executeUpdate("insert into group_comments(poster_id,com_date,com_time,group_id,content) values("+uid+",'"+date+"','"+time+"',"+id+",'"+ip+"')");
   
    
 if(n>0)
 {
  response.sendRedirect("dispgroup.jsp?id="+id+"");   
 }
 else
 {
