 ...
 <%
    ...
    for(int i=0;i<a.length;i++)
    {
        ...
        n=n+stmt.executeUpdate("delete from test where test_id="+del+"");
        n=n+stmt.executeUpdate("delete from test_questions where testid="+del+"");
    }
    if(n==a.length)
        response.sendRedirect("dash_admin.jsp?err=td");
