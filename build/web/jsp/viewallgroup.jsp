...
<div id="sidebar">
    ...
    ResultSet rs1=stmt1.executeQuery("select * from groupdetails order by g_date,g_time desc");
                       out.println("<pre style='font-family:monotype corsiva; font-size:xx-large; margin-left:400px; color:black; text-decoration:none;'> All Groups</pre>");
                        out.println("<ul>");
                        String gdesc=null;
                        int id=0;
    while(rs1.next())
    {
        id=rs1.getInt("groupid");
     gdesc=rs1.getString("group_name");
     out.println("<li style='font-family:monotype corsiva; font-size:x-large; margin-left:20px; color:black; text-decoration:none;'><a href='newjsp1.jsp?id="+id+"' style='text-decoration:none;'>"+""+gdesc+""+"</a></li>");
    }                        
                        out.println("</ul>");
                    %>
