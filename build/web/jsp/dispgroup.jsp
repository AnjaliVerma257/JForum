...
<div id="sidebar">
 ...
 Statement stm=conn.createStatement();
  ...
  ResultSet rs=stmt.executeQuery("select * from group_comments where group_id="+id+" order by com_date desc,com_time desc");
  while(rs.next())
  {      
       ...
       date=rs.getDate("com_date");
       time=rs.getTime("com_time");
       DateFormat df = new SimpleDateFormat("dd MMM,yyyy");  
  ...
  out.println("<form method='post' action='postgrpcomment.jsp?id="+id+"'>");
