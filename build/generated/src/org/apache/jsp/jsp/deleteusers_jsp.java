...
public final class deleteusers_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <li><a href=\"deletegroups.jsp\">Groups</a></li>\n");
      out.write("                <li><a href=\"deleteusers.jsp\">Users</a></li>\n");
      out.write("            </ul>\n");
      out.write("        </li>      \n");
      out.write("        \n");
      out.write("        <li>\n");
    ...
    int forum_id=0;
    String name=null;
    out.println("<form method='post' action='deleteselectedusres.jsp'>");
     out.print("<pre style='font-family:monotype corsiva; font-size:xx-large; color:black; margin-left:400px'>DELETE USERS</pre><hr style='width:700px;'>");
    while(rs.next())
    {
        forum_id=rs.getInt("userid");
