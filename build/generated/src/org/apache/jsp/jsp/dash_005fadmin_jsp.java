...
public final class dash_005fadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    while(rs1.next())
    {
     ...
     out.println("<li style='font-family:monotype corsiva; font-size:x-large; margin-left:20px; color:black; text-decoration:none;'>"+""+gdesc+""+"</li>");
    }                        
                        out.println("</ul>");
